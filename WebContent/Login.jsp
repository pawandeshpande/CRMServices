...
<%@ page import="com.crmservice.core.CRMCoreConstants "%>
<html>
  <head>
  ...
  <body onload="doValidate();">
    <p>
      ...
      &nbsp;
    </p><form name="expenseform" method="POST" action="service.svc/loginaction?cLogin">
     
      <input type="hidden" name="invaliduser"
             value='<%=request.getAttribute(CRMCoreConstants.SESSION_INVALID_CREDENTIALS)%>'>
      <table cellspacing="0" cellpadding="5" border="0" align="center"
        ...
        <tr>
          ...
          <td>
            ...
            <input type="hidden" name="action" value="Y29tLmNybXNlcnZpY2UuYWN0aW9uLkxvZ2luQWN0aW9u">
          </td>
        </tr>
        <tr>
