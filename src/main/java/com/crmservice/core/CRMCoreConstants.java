...
public class CRMCoreConstants {
  public static final String SERVLET_URL_MAPPING = "service.svc";
  ...
  public static final String PERSISTENCE_UNIT_NAME="CoreCRMServiceProviderFactory";
  public static final String PERSISTENCE_CONTEXT="CoreCRMServiceProvider";
  public static final String SESSION_EJB_NAME ="CoreCRMServiceBean";
