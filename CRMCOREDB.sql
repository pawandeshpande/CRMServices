...
SELECT 'Creating table CRM_CONTACT_AUDIT' AS ' ';
CREATE TABLE CRM_CONTACT_AUDIT (ROW_ID MEDIUMINT AUTO_INCREMENT    PRIMARY KEY ,
...
' This table can be used to enable email support for various entities.'
SELECT 'Creating table CRM_EMAIL_ENTITY' AS ' '
CREATE TABLE CRM_EMAIL_ENTITY(
 ROW_ID MEDIUMINT AUTO_INCREMENT    PRIMARY KEY ,
 EMAIL_ID MEDIUMINT,
 ENTITY_ID MEDIUMINT,'IDs of Account, Contact, Opportunity are stored here.'
'Tombstone fields'
CREATED DATETIME ,
 CREATED_BY MEDIUMINT,
 UPDATED DATETIME ,
